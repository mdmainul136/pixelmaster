...
import { Target, Calendar, ArrowRight, TrendingUp, ChevronDown, GitMerge, ShieldCheck, Zap } from "lucide-react";
const AttributionModeler = ({ container, matrix, paths, filters }) => {
  ...
  const handleDaysChange = (newDays) => {
    setDays(newDays);
    router.get(route("platform.sgtm.attribution", container.container_id), { days: newDays }, { preserveState: true });
  };
