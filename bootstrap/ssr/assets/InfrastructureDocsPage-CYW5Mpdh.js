...
import { Activity, Layers, Lightbulb, Radio, Database, Zap, Server, GitBranch, Globe, ArrowRight, Cpu, TrendingUp, CheckCircle2, Users, BarChart3, Lock, Shield, AlertTriangle, RefreshCcw, Clock, BookOpen, Eye, Info, Code2, ChevronDown, ChevronRight } from "lucide-react";
...
const Callout = ({ icon: Icon = Info, color = "blue", title, children }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: `rounded-xl border p-4 flex gap-3 ${colors[color]}`, children: [
...
const FlowStep = ({ num, icon: Icon, title, simple, technical, highlight }) => /* @__PURE__ */ jsxs("div", { className: `flex gap-4 rounded-xl p-4 border transition-colors ${highlight ? "border-emerald-500/30 bg-emerald-500/5" : "border-white/10 bg-white/3"}`, children: [
  /* @__PURE__ */ jsx("div", { className: `flex h-9 w-9 shrink-0 items-center justify-center rounded-full text-sm font-bold ${highlight ? "bg-emerald-500 text-white" : "bg-white/10 text-slate-300"}`, children: Icon ? /* @__PURE__ */ jsx(Icon, { className: "h-4 w-4" }) : num }),
  /* @__PURE__ */ jsxs("div", { className: "min-w-0", children: [
    /* @__PURE__ */ jsx("p", { className: "text-sm font-bold text-white mb-1", children: title }),
    /* @__PURE__ */ jsx("p", { className: "text-xs text-slate-400 leading-relaxed mb-1.5", children: simple }),
    technical && /* @__PURE__ */ jsx("code", { className: "text-[10px] text-emerald-400 bg-black/30 rounded px-2 py-0.5 block", children: technical })
  ] })
] });
const CodeBlock = ({ children, lang = "sql" }) => /* @__PURE__ */ jsxs("div", { className: "rounded-xl bg-[hsl(222,47%,6%)] border border-white/10 overflow-hidden", children: [
  /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between px-4 py-2 border-b border-white/10 bg-white/3", children: [
    /* @__PURE__ */ jsx("span", { className: "text-[10px] font-mono text-slate-500 uppercase", children: lang }),
    /* @__PURE__ */ jsx(Code2, { className: "h-3.5 w-3.5 text-slate-600" })
  ] }),
  /* @__PURE__ */ jsx("pre", { className: "px-5 py-4 text-[11px] font-mono text-slate-300 overflow-x-auto leading-relaxed", children })
] });
const CompareCard = ({ icon: Icon, color, title, pro, con }) => /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-white/10 bg-white/5 p-5", children: [
  /* @__PURE__ */ jsx(Icon, { className: `h-5 w-5 mb-3 ${color}` }),
  /* @__PURE__ */ jsx("p", { className: "text-sm font-bold text-white mb-3", children: title }),
  /* @__PURE__ */ jsxs("p", { className: "text-xs text-emerald-400 mb-1", children: [
    "✓ ",
    pro
  ] }),
...
const Stat = ({ value, label, color = "text-emerald-400" }) => /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-white/10 bg-white/5 p-4 text-center", children: [
  /* @__PURE__ */ jsx("p", { className: `text-2xl font-black ${color}`, children: value }),
  /* @__PURE__ */ jsx("p", { className: "text-[10px] text-slate-500 mt-1 leading-tight", children: label })
] });
  ...
  return /* @__PURE__ */ jsxs("div", { className: "border border-white/10 rounded-xl overflow-hidden", children: [
    ...
    open && /* @__PURE__ */ jsxs("div", { className: "px-6 pb-5 border-t border-white/10 pt-4 space-y-3", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex gap-2 items-start", children: [
        /* @__PURE__ */ jsx("span", { className: "rounded px-2 py-0.5 text-[9px] font-bold bg-blue-500/20 text-blue-400 uppercase shrink-0 mt-0.5", children: "Plain English" }),
      ...
      technical && /* @__PURE__ */ jsxs("div", { className: "flex gap-2 items-start", children: [
        /* @__PURE__ */ jsx("span", { className: "rounded px-2 py-0.5 text-[9px] font-bold bg-emerald-500/20 text-emerald-400 uppercase shrink-0 mt-0.5", children: "Technical" }),
        /* @__PURE__ */ jsx("p", { className: "text-xs text-slate-400 leading-relaxed", children: technical })
      ] })
    ] })
  ] });
};
function InfrastructureDocsPage() {
  const toc = [
  ...
  return /* @__PURE__ */ jsxs(PlatformLayout, { children: [
    /* @__PURE__ */ jsx(Head, { title: "Infrastructure Docs | PixelMaster Platform" }),
    /* @__PURE__ */ jsx("div", { className: "-m-4 sm:-m-6 lg:-m-8 min-h-full", style: { background: "hsl(222,47%,8%)" }, children: /* @__PURE__ */ jsxs("div", { className: "p-4 sm:p-6 lg:p-8", children: [
      /* @__PURE__ */ jsxs("div", { className: "relative overflow-hidden rounded-3xl bg-gradient-to-br from-slate-900 via-[hsl(222,47%,11%)] to-slate-900 border border-white/10 p-10 mb-8 shadow-2xl", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative z-10", children: [
          /* @__PURE__ */ jsxs("div", { className: "inline-flex items-center gap-2 rounded-full bg-emerald-500/20 border border-emerald-500/30 px-4 py-1.5 mb-5", children: [
            /* @__PURE__ */ jsx(Activity, { className: "h-3.5 w-3.5 text-emerald-400" }),
            /* @__PURE__ */ jsx("span", { className: "text-[11px] font-bold text-emerald-400 uppercase tracking-wider", children: "Platform Engineering Docs · v2.0" })
          ] }),
          /* @__PURE__ */ jsxs("h1", { className: "text-4xl font-black text-white tracking-tight mb-3 leading-tight", children: [
            "How PixelMaster Tracking",
            /* @__PURE__ */ jsx("br", {}),
            /* @__PURE__ */ jsx("span", { className: "text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-cyan-400", children: "Works — From Click to Dashboard" })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-slate-400 text-base max-w-2xl leading-relaxed mb-6", children: "Written for everyone — business owners, product managers, and engineers alike. Plain-English explanations sit alongside real code. No jargon without a definition." }),
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-3 max-w-lg", children: [
            /* @__PURE__ */ jsx(Stat, { value: "<5ms", label: "API response time", color: "text-emerald-400" }),
            /* @__PURE__ */ jsx(Stat, { value: "100x", label: "Faster analytics vs MySQL", color: "text-yellow-400" }),
            /* @__PURE__ */ jsx(Stat, { value: "100%", label: "Tenant data isolation", color: "text-blue-400" }),
            /* @__PURE__ */ jsx(Stat, { value: "0", label: "Data loss guarantee (DLQ)", color: "text-purple-400" })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 xl:grid-cols-[230px_1fr] gap-8", children: [
        /* @__PURE__ */ jsx("div", { className: "hidden xl:block", children: /* @__PURE__ */ jsxs("div", { className: "sticky top-8 rounded-2xl border border-white/10 bg-white/5 p-5 backdrop-blur-sm", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "mt-5 pt-4 border-t border-white/10", children: /* @__PURE__ */ jsxs("p", { className: "text-[10px] text-slate-600 leading-relaxed", children: [
            "Each section has a 🟦 ",
            /* @__PURE__ */ jsx("span", { className: "text-blue-400", children: "Plain English" }),
            " explanation and a 🟩 ",
            /* @__PURE__ */ jsx("span", { className: "text-emerald-400", children: "Technical" }),
            " deep-dive."
          ] }) })
        ] }) }),
        /* @__PURE__ */ jsxs("div", { className: "space-y-6 min-w-0", children: [
          /* @__PURE__ */ jsxs(
            Section,
            {
              ...
              children: [
                /* @__PURE__ */ jsxs(Callout, { icon: Lightbulb, color: "blue", title: "Simple Analogy", children: [
                  "Think of PixelMaster as a ",
                  /* @__PURE__ */ jsx("strong", { className: "text-white", children: "postal sorting facility" }),
                  ". Your website sends letters (events). The facility receives them, stamps them, sorts them by customer, stores copies in the right filing cabinets, and forwards them to Facebook, Google, etc. — all without the letter-sender waiting."
                ] }),
                /* @__PURE__ */ jsx("div", { className: "mt-5 grid grid-cols-2 md:grid-cols-4 gap-3", children: [
                ...
                ].map(({ icon: Icon, label, sub, color }) => /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-white/10 bg-white/5 p-4 text-center hover:bg-white/10 transition-colors", children: [
                  /* @__PURE__ */ jsx(Icon, { className: `h-6 w-6 mx-auto mb-2 ${color}` }),
                  /* @__PURE__ */ jsx("p", { className: "text-xs font-semibold text-white", children: label }),
                  /* @__PURE__ */ jsx("p", { className: "text-[10px] text-slate-500 mt-0.5", children: sub })
                ] }, label)) }),
                /* @__PURE__ */ jsxs("p", { className: "text-sm leading-relaxed mt-5 text-slate-300", children: [
                  "Every piece of this system answers one core question: ",
                  /* @__PURE__ */ jsx("strong", { className: "text-white", children: "how do we track millions of events per day without ever slowing down a user's website, losing data, or mixing up one client's data with another's?" })
                ] })
              ]
            }
          ),
          /* @__PURE__ */ jsxs(
            Section,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxs(Callout, { color: "green", title: "Why this design matters", children: [
                  "Traditional tracking writes to the database ",
                  /* @__PURE__ */ jsx("em", { children: "during" }),
                  " the user's page load, adding 50–200ms of latency. PixelMaster's pipeline ",
                  /* @__PURE__ */ jsx("strong", { className: "text-white", children: "acknowledges the event in under 5ms" }),
                  " and does all the heavy work in the background. Your website stays fast. Your data stays safe."
                ] })
              ]
            }
          ),
          /* @__PURE__ */ jsxs(
            Section,
            {
              ...
              children: [
                /* @__PURE__ */ jsx(Callout, { icon: Lightbulb, color: "purple", title: "Analogy", children: "Imagine a building with 100 offices. Each company has their own locked office (database). Even the building security (PixelMaster's server) uses different keys — they never have a master key that opens everything at once." }),
                ...
                ].map(({ num, title, simple, code, color }) => /* @__PURE__ */ jsxs("div", { className: `rounded-xl border ${color} bg-white/5 p-5`, children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
                    /* @__PURE__ */ jsx("span", { className: "text-[10px] font-bold bg-white/10 rounded px-2 py-0.5 text-slate-400 uppercase", children: num }),
                    /* @__PURE__ */ jsx("p", { className: "text-sm font-bold text-white", children: title })
                  ] }),
                  /* @__PURE__ */ jsx("p", { className: "text-xs text-slate-400 mb-3 leading-relaxed", children: simple }),
                  /* @__PURE__ */ jsx(CodeBlock, { lang: "code", children: code })
                ] }, num)) })
              ]
            }
          ),
          /* @__PURE__ */ jsxs(
            Section,
            {
              id: "kafka",
              icon: Radio,
              title: "Apache Kafka — The Event Bus",
              ...
              children: [
                /* @__PURE__ */ jsxs("div", { className: "grid md:grid-cols-2 gap-4 mb-5", children: [
                  /* @__PURE__ */ jsx(
                    CompareCard,
                    {
                      icon: Database,
                      color: "text-slate-400",
                      title: "Old approach: Direct DB write",
                ...
                ].map(({ title, body }) => /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-white/10 bg-white/5 p-4", children: [
                  /* @__PURE__ */ jsx("p", { className: "text-sm font-bold text-white mb-2", children: title }),
                  /* @__PURE__ */ jsx("p", { className: "text-xs text-slate-400 leading-relaxed", children: body })
                ] }, title)) })
              ]
            }
          ),
          /* @__PURE__ */ jsxs(
            Section,
            {
              id: "clickhouse",
              icon: BarChart3,
              title: "ClickHouse — Analytics Database",
              badge: "Speed",
              subtitle: "Why we have a second database just for analytics",
              color: "bg-gradient-to-r from-yellow-600/30 to-amber-500/20",
              children: [
                /* @__PURE__ */ jsxs(Callout, { icon: Lightbulb, color: "amber", title: "Analogy", children: [
                  "MySQL is like a filing cabinet — great for finding one specific file. ClickHouse is like a spreadsheet optimised for summing entire columns — ",
                  /* @__PURE__ */ jsx("strong", { className: "text-white", children: "100× faster" }),
                  ' for "give me total revenue for the last 30 days across 10 million rows."'
                ] }),
                /* @__PURE__ */ jsx("div", { className: "mt-5", children: /* @__PURE__ */ jsx(CodeBlock, { lang: "sql", children: `-- Each tenant gets their own database: tracking_{tenant_id}
CREATE TABLE IF NOT EXISTS event_logs (
  ...
  PARTITION BY toYYYYMM(created_at);                 -- auto-archives old data` }) }),
                /* @__PURE__ */ jsx("div", { className: "mt-4 grid md:grid-cols-3 gap-3", children: [
                ...
                /* @__PURE__ */ jsx("div", { className: "mt-4", children: /* @__PURE__ */ jsxs(Callout, { color: "green", title: "Provisioning command", children: [
                  "Run ",
                  /* @__PURE__ */ jsx("code", { className: "bg-white/10 px-1.5 rounded text-white mx-1", children: "php artisan tracking:clickhouse-migrate" }),
                  " to create isolated analytical databases for all active tenants. The command is idempotent — safe to run multiple times."
                ] }) })
              ]
            }
          ),
          /* @__PURE__ */ jsx(
            Section,
            {
              id: "redis",
              icon: Zap,
              title: "Redis — Speed & Deduplication Layer",
              badge: "Memory Cache",
              ...
              children: /* @__PURE__ */ jsxs("div", { className: "grid md:grid-cols-2 gap-6", children: [
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsxs("p", { className: "text-sm font-bold text-white mb-3 flex items-center gap-2", children: [
                    /* @__PURE__ */ jsx(Lock, { className: "h-4 w-4 text-red-400" }),
                    " Job 1 — Event Deduplication"
                  ] }),
                  /* @__PURE__ */ jsxs("p", { className: "text-xs text-slate-400 leading-relaxed mb-3", children: [
                    /* @__PURE__ */ jsx("strong", { className: "text-white", children: "Problem:" }),
                    " A user refreshes the page after a purchase — should that count as two purchases? No. Each event carries a unique ID. Redis remembers it for 24 hours. If the same ID arrives again, it is silently discarded."
                  ] }),
                  /* @__PURE__ */ jsx(CodeBlock, { lang: "redis", children: `-- Before processing any event:
EXISTS tracking_dedup:iphonebd:evt_abc123
→ 1  (already seen)  → skip
→ 0  (new event)     → process + SET with TTL 86400` })
                ] }),
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsxs("p", { className: "text-sm font-bold text-white mb-3 flex items-center gap-2", children: [
                    /* @__PURE__ */ jsx(Activity, { className: "h-4 w-4 text-red-400" }),
                    " Job 2 — Billing Counter"
                  ] }),
                  /* @__PURE__ */ jsxs("p", { className: "text-xs text-slate-400 leading-relaxed mb-3", children: [
                    /* @__PURE__ */ jsx("strong", { className: "text-white", children: "Problem:" }),
                    " Every processed event must increment a usage counter. Writing to MySQL for every event would be too slow. Redis can increment a counter in ",
                    /* @__PURE__ */ jsx("strong", { className: "text-white", children: "0.1 milliseconds" }),
                    ", then a scheduler syncs to MySQL hourly."
                  ] }),
                  /* @__PURE__ */ jsx(CodeBlock, { lang: "redis", children: `-- Each processed event:
INCR tracking_usage:iphonebd:2026-03-30:events_received
-- ~0.1ms. No DB hit.

-- Hourly scheduler syncs to MySQL:
UPDATE tenant_usage_quotas SET used_count = [redis_value]` })
                ] })
              ] })
            }
          ),
          /* @__PURE__ */ jsxs(
            Section,
            {
              id: "security",
              icon: Shield,
              title: "Origin Enforcement & Snippet Security",
              badge: "Anti-Theft",
              ...
              children: [
                /* @__PURE__ */ jsx(Callout, { icon: AlertTriangle, color: "amber", title: "Real Threat Scenario", children: "A bad actor visits your website, copies your GTM container ID (e.g. GTM-ABC123), and pastes it into their own website. Without protection, they could send fake events to your account, consume your quota, or poison your analytics." }),
                /* @__PURE__ */ jsx("div", { className: "mt-5 space-y-2 mb-5", children: [
                ...
                ].map(({ n, t, d }) => /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3 rounded-lg p-3 hover:bg-white/5 transition-colors", children: [
                  /* @__PURE__ */ jsx("span", { className: "flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-blue-500/20 text-[10px] font-bold text-blue-400", children: n }),
                  /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx("p", { className: "text-xs font-semibold text-white", children: t }),
                    /* @__PURE__ */ jsx("p", { className: "text-[11px] text-slate-500 mt-0.5 leading-relaxed", children: d })
                  ] })
                ] }, n)) }),
                /* @__PURE__ */ jsx(CodeBlock, { lang: "php", children: `// EnforceContainerOrigin middleware (simplified)
    ...
    abort(403, 'Origin not authorised.');
          ...
          /* @__PURE__ */ jsxs(
            Section,
            {
              id: "dlq",
              icon: RefreshCcw,
              title: "Dead Letter Queue — Zero Data Loss",
              badge: "Reliability",
              ...
              children: [
                /* @__PURE__ */ jsx(Callout, { icon: Lightbulb, color: "purple", title: "Analogy", children: "Imagine a delivery courier. If no one is home, instead of throwing the parcel away, they leave a card and try again — first in 1 minute, then 5 minutes, then an hour. PixelMaster's DLQ does the same for failed event writes." }),
                /* @__PURE__ */ jsxs("div", { className: "grid md:grid-cols-2 gap-5 mt-5", children: [
                  /* @__PURE__ */ jsxs("div", { className: "rounded-xl bg-white/5 border border-white/10 p-5", children: [
                    /* @__PURE__ */ jsxs("p", { className: "text-sm font-bold text-white mb-4 flex items-center gap-2", children: [
                    ...
                    ].map(([a, d, note]) => /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between text-xs", children: [
                      /* @__PURE__ */ jsx("span", { className: "text-slate-400", children: a }),
                      /* @__PURE__ */ jsx("span", { className: "font-mono text-emerald-400", children: d }),
                      /* @__PURE__ */ jsx("span", { className: "text-slate-600 text-[10px] hidden md:block", children: note })
                    ] }, a)) })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { className: "rounded-xl bg-white/5 border border-white/10 p-5", children: [
                    /* @__PURE__ */ jsx("p", { className: "text-sm font-bold text-white mb-4", children: "DLQ Entry Lifecycle" }),
                    /* @__PURE__ */ jsx("div", { className: "space-y-2", children: [
                    ...
                    ].map(([status, color, desc]) => /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-2 text-xs", children: [
                      /* @__PURE__ */ jsx("span", { className: `font-mono w-20 shrink-0 ${color}`, children: status }),
                      /* @__PURE__ */ jsx("span", { className: "text-slate-500", children: desc })
                    ] }, status)) })
                  ] })
                ] }),
                /* @__PURE__ */ jsx("div", { className: "mt-4", children: /* @__PURE__ */ jsxs(Callout, { color: "green", title: "Artisan commands", children: [
                  /* @__PURE__ */ jsx("code", { className: "text-white", children: "tracking:process-retry-queue" }),
                  " — runs every minute via scheduler.",
                  " ",
                  /* @__PURE__ */ jsx("code", { className: "text-white", children: "tracking:expire-dlq --days=7" }),
                  " — runs daily at 02:30 AM."
                ] }) })
              ]
            }
          ),
          /* @__PURE__ */ jsxs(
            Section,
            {
              id: "billing",
              icon: TrendingUp,
              title: "Billing Quota & Usage Metering",
              ...
              children: [
                /* @__PURE__ */ jsx("div", { className: "flex items-center gap-2 overflow-x-auto pb-2 mb-5", children: ["Event received", "Redis INCR (0.1ms)", "Hourly scheduler", "MySQL sync", "Usage dashboard"].map((step, i, arr) => /* @__PURE__ */ jsxs(React__default.Fragment, { children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center text-center shrink-0", children: [
                    /* @__PURE__ */ jsx("div", { className: "h-8 w-8 rounded-full bg-teal-500/20 border border-teal-500/30 flex items-center justify-center text-[10px] font-bold text-teal-400", children: i + 1 }),
                    /* @__PURE__ */ jsx("p", { className: "text-[10px] text-slate-500 mt-1.5 max-w-[64px] leading-tight", children: step })
                  ] }),
                  i < arr.length - 1 && /* @__PURE__ */ jsx("div", { className: "flex-1 h-px bg-white/10 min-w-[20px] shrink-0" })
                ] }, step)) }),
                /* @__PURE__ */ jsxs("div", { className: "grid md:grid-cols-2 gap-4", children: [
                  /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-white mb-2", children: "Quota Alert Thresholds" }),
                    /* @__PURE__ */ jsx("div", { className: "space-y-2", children: [
                    ...
                    ].map(({ pct, color, msg }) => /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 rounded-lg border border-white/10 p-3", children: [
                      /* @__PURE__ */ jsx("span", { className: `text-[10px] font-bold text-white px-2 py-0.5 rounded ${color}`, children: pct }),
                      /* @__PURE__ */ jsx("p", { className: "text-xs text-slate-400", children: msg })
                    ] }, pct)) })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-white mb-2", children: "Monthly Reset" }),
                    /* @__PURE__ */ jsx("p", { className: "text-xs text-slate-400 leading-relaxed", children: "Alert flags are stored in Redis with a key expiring on the 1st of each month. When the month rolls over, counters reset automatically — no cron job needed for the reset itself." }),
                    /* @__PURE__ */ jsx(CodeBlock, { lang: "redis", children: `Key: billing_alert:iphonebd:80pct:2026-03
TTL: expires on 2026-04-01 00:00:00` })
                  ] })
                ] })
              ]
            }
      ...
      /* @__PURE__ */ jsxs("div", { className: "mt-8 rounded-2xl border border-white/10 bg-white/5 p-6 flex flex-col md:flex-row items-center justify-between gap-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsx(Eye, { className: "h-4 w-4 text-slate-600" }),
          /* @__PURE__ */ jsx("p", { className: "text-xs text-slate-500", children: "PixelMaster Platform Engineering Docs · Laravel 12 + React + Inertia.js" })
        ] }),
        /* @__PURE__ */ jsx(
          "a",
          {
...
export {
  InfrastructureDocsPage as default
};
